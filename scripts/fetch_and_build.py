...
ENGDB_VERTICAL_MAP = {
    ...
    "joao.gallo@engdb.com.br": "E&U",
    "ricardo.araujo@engdb.com.br": "E&U",
    "amarildo.paixao@engdb.com.br": "I&S",
    "jhonantan.amorim@engdb.com.br": "I&S",
    "paulo.franca@engdb.com.br": "Arq",
    "rodrigo.afonso@engdb.com.br": "Cloud",
    "fabricio.pellizon@engdb.com.br": "Cloud",
}
...
def main():
    ...
    for group in GROUPS:
        ...
        od_total = data["stats"].get("total_od_cost", 0)
        od_members = data["stats"].get("od_members", 0)
        print(f"  → {data['stats']['total_members']} membros, {data['stats']['active_members']} ativos, {data['stats']['total_requests']:,} requests")
        if od_total > 0:
            print(f"  → On-Demand: {od_members} membros, US$ {od_total:.2f}\n")
        else:
            print()
